...
@import url('https://fonts.googleapis.com/css?family=Plex');
  ...
  * {
  ...
  body {
    font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Roboto Light', 'Oxygen',
      ...
      'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Verdana';
  ...
  .navbar-default .navbar-toggle .icon-bar {
    background-color: #2A1F9D !important;
  }
  ...
  .navBarDefault {
    background: linear-gradient(to right, #0 0%, #2A1F9D 100%);
    border-radius: 0;
    border-top: 0;
    margin-bottom: 0;
    border: 0;
