# Checklist: Variable length records {#SARChVarLenRec .reference}
...
See help topic "**Troubleshooting: Variable length records**". A link to that topic is under **Related reference** below.
