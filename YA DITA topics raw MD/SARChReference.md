# Checklist: Reference phase {#SARChReference .reference}
...
See help topic "**Troubleshooting: Reference phase**". A link to that topic is under **Related reference** below.
