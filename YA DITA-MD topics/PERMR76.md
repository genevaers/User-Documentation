# Program Runbook: MR76 LT to EBCDIC {#PERMR76 .reference}

## 01 Summary of this topic {#01 .section}

The sections in this topic are as follows:

-   [02 Diagrams](PERMR76.md#02)
-   [03 What MR76 does](PERMR76.md#03)
-   [05 Checklist for logic phase](PERMR76.md#05)
-   [10 PARM options for MR76 step](PERMR76.md#10)
-   [20 DD LTIN - JLT file or XLT file in ASCII format](PERMR76.md#20)
-   [30 DD LTOUT - JLT file or XLT file in EBCDIC format](PERMR76.md#30)
-   [40 DD MR76RPT - Logic Table Conversion Process Report](PERMR76.md#40)
-   [80 JCL Sample](PERMR76.md#80)
-   [99 Troubleshooting](PERMR76.md#99)
-   [100 Need more on this page?](PERMR76.md#100)

## 02 Diagrams {#02 .section}

![](images/MR76_Action_02_JLT.gif)

![](images/MR76_Action_01_XLT.gif)

## 03 What MR76 does {#03 .section}

MR76 translates a logic table file from ASCII to EBCDIC. The logic table file could be the JLT or XLT.
...
## 10 PARM options for MR76 step {#10 .section}

No PARM options.

## 20 DD LTIN - JLT file or XLT file in ASCII format {#20 .section}

DDNAME LTIN is an input file that is one of the logic table files - JLT or XLT. The LTIN file uses ASCII format.
...
## 30 DD LTOUT - JLT file or XLT file in EBCDIC format {#30 .section}

DDNAME LTOUT is an output file that is the same logical content as the input file - JLT or XLT. The LTOUT file uses EBCDIC format.
...
## 40 DD MR76RPT - Logic Table Conversion Process Report {#40 .section}

DDNAME MR76RPT is for a report about MR76 processing. A sample is below:
...
GVBMR76 - Logic Table Conversion Process                  
(Rev. 00000000: 2012-05-10 22:03)                         
                                                          
Executed: 2012-10-03 09:40:55                             
                                                          
 BLOCKS READ..........00000003                            
 RECORDS ASSEMBLED....00000027                            
 RECORDS WRITTEN......00000027 
```
...
See help topic "**Troubleshooting MR76**". A link to that overviews is under **Related reference** below.
