...
|**SELECTIF(NOT COL.6 = ALL("-"))**|Select for output those records with column 6<br>is not equal to all dashes.<br>Skip all other records.<br>This example gives the same result as:<br>&nbsp;&nbsp;&nbsp;&nbsp;**SKIPIF(COL.6 = ALL("-"))**|
...
|**SKIPIF(COL.6 = ALL("-"))**|Skip for output those records with column 6<br>equal to all dashes.<br>Select all other records.|
...
|**IF NOT (COL.6 = ALL("-"))<br>&nbsp;&nbsp;&nbsp;&nbsp;THEN SELECT<br>ENDIF**|Select for output those records with column 6<br>not equal to all dashes. Skip all other records.<br>This example gives the same result as:<br>&nbsp;&nbsp;&nbsp;&nbsp;**SKIPIF(COL.6 = ALL("-"))**|
|**IF (COL.6 = REPEAT("-", 13))<br>&nbsp;&nbsp;&nbsp;&nbsp;THEN SELECT<br>ENDIF**|Select for output those records with column 6 <br>equal to 13 dashes. Skip all other records.|
...
|**IF (COL.6 = ALL("-"))<br>&nbsp;&nbsp;&nbsp;&nbsp;THEN SKIP<br>ENDIF**|Skip for output those records with column 6<br>is equal to all dashes. Select all other records.<br>This example gives the same result as:<br>&nbsp;&nbsp;&nbsp;&nbsp;**SKIPIF(COL.6 = ALL("-"))**|
