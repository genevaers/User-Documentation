...
| | |
|Ctrl + L|Display the **GenevaERS Login** screen. This keyboard shortcut achieves the same result as clicking **File -\> Return to login...**.|
| | |
