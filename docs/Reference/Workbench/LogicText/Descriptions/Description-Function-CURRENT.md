...
CURRENT is used by specifying the name of the field, for example:
...
If you use PRIOR, it is recommended you use the CURRENT function for fields that refer to the current source record. This is not necessary but recommended because it makes the logic text much easier to understand. For example:  
